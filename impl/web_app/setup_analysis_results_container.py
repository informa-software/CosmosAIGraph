...
This script creates the analysis_results container in CosmosDB
with the appropriate partition key and indexing policy.

This container stores comparison and query results for PDF generation
...
async def setup_analysis_results_container():
    """Create analysis_results container"""

    logger.info("Starting Analysis Results container setup...")
    ...
    # Load index policy
    index_policy_path = Path(__file__).parent / "config" / "cosmosdb_nosql_analysis_results_index_policy.json"
    ...
    try:
        ...
        logger.info("")
        logger.info("========================================")
        logger.info("Analysis Results Container Setup Complete!")
        logger.info("========================================")
        logger.info("")
        ...
        logger.info("  - Comparison results (for PDF generation)")
        logger.info("  - Query results (with contract filenames)")
        logger.info("  - Result metadata and execution history")
        logger.info("")
        logger.info("Next steps:")
        logger.info("1. Deploy backend API with AnalysisResultsService")
        logger.info("2. Integrate with Compare Contracts page")
        logger.info("3. Integrate with Query Contracts page")
        logger.info("4. Test PDF generation workflow")
        logger.info("")
...
if __name__ == "__main__":
    asyncio.run(setup_analysis_results_container())
