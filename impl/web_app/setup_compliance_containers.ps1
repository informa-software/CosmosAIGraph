# Setup Compliance Containers (PowerShell Wrapper)
# Creates the CosmosDB containers needed for the compliance system

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Compliance Containers Setup" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
